...
<body>
    ...
    <main class="main-content">
        <div class="container-fluid">
            ...
            <form id="createTaskForm" accept="tesk_creacte_action.php">
                <div class="form-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">
                                วันที่ครบกำหนด <span class="text-danger">*</span>
                            </label>
                ...
                <div class="form-card">
                    ...
                    <div class="file-upload-area" id="fileUploadArea">
                        ...
                        <input type="file" id="fileInput" name="fileInput" multiple hidden>
                    </div>
    ...
    <script>
        ...
        document.getElementById('createTaskForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                updateStars(0);
                importanceLabel.textContent = 'กรุณาเลือกระดับความเร่งด่วน';
                importanceLabel.style.color = '#64748b';

                submitBtn.innerHTML = '<i class="bi bi-check-circle me-2"></i>สร้างงาน';
